...
# set GPIO 17 as GREENPIN
GREENPIN = 17

# set GPIO 27 as YELLOWPIN
YELLOWPIN = 27

# set GPIO 22 as REDPIN
REDPIN = 22
...
# setup function for sime setup---custom functio
def setup():
...
def main():
    ...
    while True:
        ...
        if result:
            ...
            print "humidity: %s %%,  Temperature: %s C, discomfort: %s" % (humidity, temperature, discomfort)
        time.sleep(1)
